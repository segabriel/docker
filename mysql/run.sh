...
MYSQL_DATA_HOME="/opt/docker/mysql/data"
MYSQL_LOG_HOME="/opt/docker/mysql/log"

rm -rf ${MYSQL_DATA_HOME} ${MYSQL_LOG_HOME}
mkdir -p ${MYSQL_DATA_HOME} ${MYSQL_LOG_HOME}
chmod -R 777 ${MYSQL_DATA_HOME} ${MYSQL_LOG_HOME}
